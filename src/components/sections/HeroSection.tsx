...
export function HeroSection({ children }: HeroSectionProps) {
  ...
  return (
    <section
      ref={heroRef}
      className="relative overflow-hidden text-[#2E241C] px-4 sm:px-[60px] bg-[url('/assets/hero/GENERATED.webp')] bg-cover bg-center lg:bg-[position:99%_50%] bg-no-repeat"
